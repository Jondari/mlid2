...
CREATE DATABASE inter0002 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

GRANT ALL ON inter0002.* TO 'gio'@'localhost' IDENTIFIED BY 'wikiEsa';
...
INSERT INTO inter0002.inter
SELECT 'zh', page.page_title, langlinks.ll_lang, langlinks.ll_title
FROM page, langlinks
WHERE page.page_id = langlinks.ll_from
AND   page.page_namespace = 0;

SELECT 'Ajout des éléments "zh" à inter terminé.';
